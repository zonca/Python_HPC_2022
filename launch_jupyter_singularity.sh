...
galyleo.sh launch --account $ACCOUNT --partition 'debug' --cpus-per-task 128 --time-limit 00:30:00 --jupyter 'lab' --notebook-dir "${NOTEBOOK_FOLDER}" --env-modules 'singularitypro' --bind '/expanse,/scratch' --sif "${SIMG}"
